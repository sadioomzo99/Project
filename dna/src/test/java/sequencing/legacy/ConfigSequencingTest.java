...
public class ConfigSequencingTest {

    public static void main(String[] args) {
        BufferedCsvWriter writer = new BufferedCsvWriter("D:/Promotion/paper_4/results/new/sequencing_configs.csv", false);
        ...
        for (Bitrate bitrate : List.of(
            ...
            for (int b : List.of(8, 32, 64, 128, 256, 512, 1024)) {
                int internalNodePointers = 2 * b - 1;
                for (int c : List.of(8, 32, 64, 128, 256, 512, 1024)) {
                    int leafSize = 2 * c - 1;
