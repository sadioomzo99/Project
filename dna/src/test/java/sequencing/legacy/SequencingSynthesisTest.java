...
public class SequencingSynthesisTest {

    public static void main(String[] args) {
        BufferedCsvWriter writer = new BufferedCsvWriter("D:/Promotion/paper_4/results/new/sequencing_synthesis_analysis.csv", false);
        ...
        for (Bitrate bitrate : List.of(
            ...
            for (int b : List.of(64)) {
                ...
                for (int c : List.of(64)) {
                    int leafSize = 2 * c - 1;
                    for (long numberTuples : List.of(1000L, 10_000L, 100_000L, 400_000L, 600_000L, 800_000L, 1000_000L)) {
